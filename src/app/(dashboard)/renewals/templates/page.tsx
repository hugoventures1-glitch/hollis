    ...
    <div className="flex flex-col h-full bg-[#0C0C0C]">
      ...
      <div className="flex items-center gap-3 px-10 h-[56px] border-b border-[#1C1C1C] shrink-0">
        ...
        <div className="ml-auto flex items-center gap-2">
          <span className={`text-[12px] ${allApproved ? "text-[#FAFAFA]" : "text-[#555555]"}`}>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto px-10 py-10">
          ...
          {loading ? (
            <div className="flex items-center justify-center py-24 text-[#333333]">
                    ...
                    <div className="flex items-center justify-between px-5 py-4 border-b border-[#1C1C1C]">
                      <div className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                          ...
                          <Icon size={15} className={t?.is_approved ? "text-[#FAFAFA]" : "text-[#555555]"} />
                        </div>
                        <div>
                          <div className="text-[14px] font-medium text-[#FAFAFA]">
                            {TOUCHPOINT_LABELS[type]}
                          </div>
                          <div className="text-[12px] text-[#333333] mt-0.5">{meta.desc}</div>
                        </div>
                      </div>
                        ...
                        <button
                          ...
                          className={`h-7 px-3 flex items-center gap-1.5 rounded-md text-[12px] font-medium transition-colors ${
                            t?.is_approved
                              ...
                              : "bg-[#ffffff08] text-[#555555] border border-[#ffffff12] hover:text-[#FAFAFA]"
                          }`}
                        >
                          {t?.is_approved ? (
                    ...
                    <div className="px-5 py-4">
                      {isEditing ? (
                        <div className="space-y-3">
                          {meta.hasSubject && (
                            <div>
                              <label className="block text-[11px] font-medium text-[#555555] mb-1.5 uppercase tracking-wider">
                                Subject
                              </label>
                              <input
                                type="text"
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              rows={10}
                              className="w-full bg-[#0C0C0C] border border-[#1C1C1C] rounded-lg px-3 py-2.5 text-[13px] text-[#FAFAFA] outline-none focus:border-[#555555] placeholder-[#333333] resize-y font-mono leading-relaxed"
                          ...
                          <div className="flex items-center gap-2 pt-1">
                            <button
                              onClick={cancelEdit}
                              className="h-8 px-4 rounded-md border border-[#1C1C1C] text-[12px] text-[#555555] hover:text-[#FAFAFA] transition-colors"
                            >
                              Cancel
                            </button>
                            <button
                        ...
                        <div>
                          {meta.hasSubject && t?.subject && (
                            <div className="text-[12px] font-medium text-[#555555] mb-2">
                              Subject: <span className="text-[#FAFAFA]">{t.subject}</span>
                            </div>
                          )}
                          <pre className="text-[12px] text-[#555555] whitespace-pre-wrap font-sans leading-relaxed max-h-48 overflow-y-auto">
                            {t?.body ?? ""}
                          </pre>
                          {t?.is_approved && t?.approved_at && (
                            <div className="mt-3 text-[11px] text-[#333333]">
                              Approved{" "}
