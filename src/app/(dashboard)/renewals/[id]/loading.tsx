    ...
    <div className="flex flex-col h-full overflow-hidden" style={{ background: "#0C0C0C" }}>
      ...
      >
        ...
        <div className="flex gap-2">
          <div className="h-7 w-24 rounded-lg bg-[#141414] animate-pulse" />
          <div className="h-7 w-20 rounded-lg bg-[#141414] animate-pulse" />
        </div>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Right panel */}
        <div
          className="shrink-0 flex flex-col gap-4 p-6 overflow-hidden"
          style={{ width: 280, borderLeft: "1px solid #181818" }}
        >
