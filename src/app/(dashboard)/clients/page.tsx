      ...
      <div className="flex-1 overflow-y-auto" style={{ marginTop: 21 }}>
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-6">
            ...
            <h2 className="text-[16px] font-semibold mb-1" style={{ color: "var(--text-primary)" }}>No clients yet</h2>
            <p className="text-[13px] mb-6 max-w-xs" style={{ color: "var(--text-secondary)" }}>
          ...
          <div className="flex items-center justify-center py-24 text-[13px]" style={{ color: "var(--text-tertiary)" }}>
