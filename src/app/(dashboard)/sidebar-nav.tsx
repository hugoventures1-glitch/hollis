  ...
  return (
    ...
    >
      ...
      <div className="px-4 flex-1 overflow-y-auto space-y-0.5">
        {/* Search */}
        <button className="w-full flex items-center justify-between px-2.5 py-[9px] rounded-[4px] text-[#8a8b91] hover:bg-white/[0.04] hover:text-[#f5f5f7] transition-colors group">
          <div className="flex items-center gap-3">
            <Search
              size={18}
              strokeWidth={1.5}
